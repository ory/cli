...
usage() {
  this=$1
  cat <<EOF
$this: download the $PROJECT_NAME binary
...
get_binaries() {
  case "$PLATFORM" in
    darwin/amd64) BINARIES="ory" ;;
    darwin/arm64) BINARIES="ory" ;;
    linux/amd64) BINARIES="ory" ;;
    linux/arm64) BINARIES="ory" ;;
    windows/amd64) BINARIES="ory" ;;
    *)
