...
[Contributor License Agreement](https://cla-assistant.io/ory/cli).
...
[docs](https://github.com/ory/cli/tree/master/docs) folder. Generate API and
...
1. Ensure that each commit has a subsystem prefix (ex: `controller:`).
   [List of subsystem prefixes for CLI](https://github.com/ory/ory/cli/blob/master/.github/semantic.yml)
   (if applicable).
...
git clone git@github.com:ory/ory/cli.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/cli.git
